      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-black via-[#0a0a0a] to-[#1a1a1a] text-white border-b border-white/10 py-24">
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center fade-in">
            <p className="text-[#FFD700] font-semibold mb-4">Lanzamiento 18 · 01 · 2026</p>
            ...
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
              <Card className="bg-white/5 border-white/10 backdrop-blur-sm">
                <CardContent className="p-8 text-center">
                  <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-[#FFD700]/10 border border-[#FFD700]/30 text-[#FFD700] mb-6">
            ...
            <div className="grid gap-8 sm:grid-cols-3">
              <Card className="bg-white/5 border-white/10 backdrop-blur-sm hover:border-[#FFD700]/30 transition-all">
                <CardContent className="p-8 text-center">
                  ...
                  <div className="text-4xl font-bold text-[#FFD700] mb-4">€2,99</div>
                  <p className="text-white/60">
              ...
              <Card className="bg-white/5 border-white/10 backdrop-blur-sm hover:border-[#FFD700]/30 transition-all">
                <CardContent className="p-8 text-center">
                  ...
                  <div className="text-4xl font-bold text-[#FFD700] mb-4">€6,99</div>
                  <p className="text-white/60">
              ...
              <Card className="bg-white/5 border-white/10 backdrop-blur-sm hover:border-[#FFD700]/30 transition-all">
                <CardContent className="p-8 text-center">
                  ...
                  <div className="text-4xl font-bold text-[#FFD700] mb-4">Flexible</div>
          ...
          <div className="mb-20">
            <Card className="bg-[#FFD700]/5 border-[#FFD700]/20 backdrop-blur-sm">
              <CardContent className="p-12 text-center">
                <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-[#FFD700]/10 border border-[#FFD700]/30 text-[#FFD700] mb-6">
